...
public class StudyRoomController {
    ...
    @GetMapping("/internal/list") @Operation(summary = "内部接口：获取未删除自习室列表")
    public List<StudyRoom> getRoomsInternal() {
        return roomService.lambdaQuery().ne(StudyRoom::getStatus, "DELETED").list();
    }
}