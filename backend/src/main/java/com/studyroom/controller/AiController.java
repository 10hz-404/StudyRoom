...
@RestController @RequestMapping("/api/v1/ai") @RequiredArgsConstructor @Tag(name = "AI????")
public class AiController {
    ...
    public R<?> recommend(HttpServletRequest request) {
        ...
        List<StudyRoom> rooms = roomService.lambdaQuery().eq(StudyRoom::getStatus, "ACTIVE").list();
